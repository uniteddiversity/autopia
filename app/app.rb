module ActivateApp
  class App < Padrino::Application
    ...
    get '/h/:slug' do        
      ...
      @memberships = @memberships.where(:account_id.in => Account.where(:paid.ne => nil).pluck(:id)) if params[:paid]
      @memberships = @memberships.where(:account_id.in => Account.where(:paid => nil).pluck(:id)) if params[:not_paid]
