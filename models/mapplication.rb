  ...
  after_create do
    if ENV['SENDGRID_USERNAME']
      ...
      html_part = Mail::Part.new do
        ...
        body "#{account.name} expressed their interest in joining #{group.name}. Visit http://#{ENV['DOMAIN']}/h/#{group.slug} to review the application.<br /><br />Best,<br />Team Huddl"
      end
